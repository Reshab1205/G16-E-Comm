...
const userSchema = new mongoose.Schema({
    ...
    add_to_cart: [{product_id: {type:mongoose.Schema.Types.ObjectId, ref:'product'}}],
    add_to_wishlist: [{product_id: {type:mongoose.Schema.Types.ObjectId, ref:'product'}}],
    ...
    wallet_kyc_status:{
        ...
        aadhar_card_number:{type:Number},
